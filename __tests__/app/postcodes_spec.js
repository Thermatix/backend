...
describe("postcodes", () => {
    describe("lookup", () => {
        ...
        it("should return latlon for given postcode", async () => {
        ...
        describe("when given a postcode in the incorrect format", () => {
            var postcode = "E14 7T";
            var errorMsg = "result was undefined or not found, Postcode format could be incorrect";
    ...
    describe("batch_lookup", () => {
        ...
        it("should return an array of latlon for given postcodes", async () => {
